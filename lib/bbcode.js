...
exports.parse = function(post, cb) {
  ...
  var tagname_re = /^\/?(?:b|i|u|pre|samp|code|colou?r|size|noparse|url|link|s|q|blockquote|img|u?list|li|ul|ol|font|left|center|right|sub|sup|hr)$/i;
  ...
  function textToHtmlCB(mstr, m1, m2, m3, m4, offset, string)
  {
    ...
    if(isValidTag(m2)) {
      ...
      switch (m2l) {
        ...
        case "ol":
        case "list":
          opentags.push(new taginfo_t(m2l, '</ol>'));
          return '<ol>';

        case "ul":
        case "ulist":
          opentags.push(new taginfo_t(m2l, '</ul>'));
          return '<ul>';
