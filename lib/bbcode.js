...
exports.parse = function(post, cb) {
  ...
  var tagname_re = /^\/?(?:b|i|u|pre|samp|code|colou?r|size|noparse|url|link|s|q|blockquote|img|u?list|li|ul|ol|font|left|center|right|sub|sup)$/i;
      ...
      switch (m2l) {
        ...
        case "size":
          if(!m3 || !number_re.test(m3))
            m3 = "1";
          opentags.push(new taginfo_t(m2l, "</font>"));
          return '<font size="' + m3 + '">';
        ...
        case "ol":
          opentags.push(new taginfo_t('ol', '</ol>'));
          return '<ol>';
        ...
        case "ul":
          opentags.push(new taginfo_t('ul', '</ul>'));
          return '<ul>';
        ...
        case "li":
          opentags.push(new taginfo_t('li', '</li>'));
          return '<li>';
        ...
        case "left":
          opentags.push(new taginfo_t('left', '</div>'));
          return '<div align="left">';

        case "right":
          opentags.push(new taginfo_t('right', '</div>'));
        ...
        case "center":
          opentags.push(new taginfo_t('center', '</div>'));
          return '<div align="center">';

        case "sub":
          opentags.push(new taginfo_t('sub', '</sub>'));
          return '<sub>';

        case "sup":
          opentags.push(new taginfo_t('sup', '</sup>'));
          return '<sup>';
